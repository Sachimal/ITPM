      ...
      <div className="App">
        <div className="LoginComponent">
          <div className="Description">
            <h1>AquaClean</h1>
            <p>
            Get involved and help bring clean water to those in need by donating or fundraising. 
            Help to provide clean, safe drinking water to a  developing village.
          ...
          <Alert className={"fix-alert"} show={this.state.registerFailShow} variant={"danger"} onClose={() => this.setRegisterFailShow(false)} dismissible>
            <Alert.Heading>There is a problem</Alert.Heading>
            <p>
              invalid credential. 
            </p>
          </Alert>
